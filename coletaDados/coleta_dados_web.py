...
def conta_tag():
    ...
    for linhaq in extracao.find_all('p'): # Seleciona e conta a quantidade de parágrafos;
...
def coleta_aninhada():
    for titulo in extracao.find_all('h2'): # Localiza todos os títulos 'h2';
        ...
        for link in titulo.find_next_siblings('p'): # Realiza um segundo loop buscando por todas as tags 'p' afilhas das tags 'h2';
            for a in link.find_all('a'): # Finalmente busca por todas as tags 'a' dentro das tags 'p';
